...
$query =
"INSERT INTO pds_base (data, hora, lat, lon, toriline, tingida, obs, lance) 
	VALUES ('$data', '$hora', '$lat', '$lon', '$toriline', '$tingida', '$obs', '$lance')";
...
for ($i=0; $i < $elementos; $i++){
		$query = "INSERT INTO pds_cont (cont_id, cont_hora, cont_total, especie, cont_esp) VALUES ('$cont_id', '$cont_hora', '$cont_total', '$combo[$i]', '$cont_esp[$i]')";
		$result = mysql_query($query, $link);
	}
