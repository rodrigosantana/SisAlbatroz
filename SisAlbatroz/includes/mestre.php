...
<HTML lang="pt-br"> <!--  Abre o arquivo do tipo HTML e defini a linguagem como portugues do Brasil !-->
	...
	<TITLE> Mestres </TITLE> <!-- Cabeçalho que vai no titulo da aba do navegador !-->
	...
	<LINK rel="stylesheet" type="text/css" href="../css/form.css" /> <!-- Faz o link com a página de CSS e chama o arquivo !-->
 	...
 	<BODY>
        <DIV class="box"> <!-- Define o BOX principal com o formulário!-->
            <FORM id="form" method="post" action="recebe_mestre.php"> <!-- Tipo de formulário e como as informações vão ser enviadas !-->
                <H1> CADASTRO DE MESTRES DE EMBARCAÇÃO </H1> <!-- Cabeçalho da caixa principal do formulário !-->
